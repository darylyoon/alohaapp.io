                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Contact an Aloha Relationship Manager</h5>
                            </div>
                            <div class="modal-body">
                              <div class="mb-3">
                                ...
                                <input type="number" class="form-control mb-3" id="exampleFormControlInput1" placeholder="Mobile Number" />
                                <label for="exampleFormControlInput1" class="form-label">List 3 Team goals for the upcoming experience</label>
                                <input type="text" class="form-control mb-3" id="exampleFormControlInput1" placeholder="To connect and communicate, to build trust among employees, to learn more about sustainability" />
                              </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn sr">Send request</button>
